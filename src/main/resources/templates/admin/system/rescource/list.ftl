...
<div class="layui-form users_list">
    ...
    <script type="text/html" id="qrUrl">
        <span class="layer-photos-demo" id="pic_{{d.id}}"><img src="{{ d.qrUrl }}" layer-src="{{ d.qrUrl }}" style="width: 60px;" lay-event="showPic" ></span>
    </script>
    ...
    layui.use(['layer','form','table'], function() {
        ...
        t = {
            ...
            cols: [[
                ...
                {field:'clicks',  title: '下载次数'},
                {field:'qrUrl',     title: '地址',templet:'#qrUrl'},
